      ...
      <>
          ...
          <SectionMain>
            ...
            <CardBox>
                ...
                <>
                    <p className={'block font-bold mb-2'}>Projects User</p>
                    <CardBox
                    ...
                    >
                        <div className='overflow-x-auto'>
                            ...
                            <tbody>
                            {users.projects_user && Array.isArray(users.projects_user) &&
                              users.projects_user.map((item: any) => (
                        ...
                        {!users?.projects_user?.length && <div className={'text-center py-4'}>No data</div>}
                    </CardBox>
                </>
