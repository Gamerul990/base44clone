...
const EditCode_repositories = () => {
  ...
  const { code_repositoriesId } = router.query

  useEffect(() => {
    dispatch(fetch({ id: code_repositoriesId }))
  }, [code_repositoriesId])
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: code_repositoriesId, data }))
...
EditCode_repositories.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated>
          {page}
      </LayoutAuthenticated>
...
export default EditCode_repositories
